...
//            graphics.setFont(new Font("Times New Roman", Font.BOLD, 24));
            //修复bug：解决1ilL分不清的bug by 吕佳诚
            graphics.setFont(new Font("Verdana", Font.ITALIC, 22));
            // 设置字符，字符间距，上边距
     ...
     *         2012-2-28 下午2:15:14
     * <br>修改：吕佳诚，去除掉容易混绕的字符：01，ilo,ILO等
     */
    enum RandCodeImageEnum {
        /**
         * 混合字符串
         */
        ALL_CHAR("23456789abcdefghkmnpqrstuvwxyzABCDEFGHKMNPQRSTUVWXYZ"),
        /**
         * 字符
         */
        LETTER_CHAR("abcdefghkmnpqrstuvwxyzABCDEFGHKMNPQRSTUVWXYZ"),
        /**
         * 小写字母
         */
        LOWER_CHAR("abcdefghkmnpqrstuvwxyz"),
        /**
         * 数字
         */
         ...
         * 大写字符
         */
        UPPER_CHAR("ABCDEFGHKMNPQRSTUVWXYZ");
        /**
         * 待生成的字符串
         */
