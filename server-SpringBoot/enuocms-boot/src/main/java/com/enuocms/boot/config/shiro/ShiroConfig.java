...
//        //注入缓存管理器;
//        securityManager.setCacheManager(ehCacheManager());//这个如果执行多次
...
//        filterChainDefinitionMap.put("/", "user");
    ...
    @Bean
    public AccountAuthorizationRealm myShiroRealm() {
        HashedCredentialsMatcher hashedCredentialsMatcher = new HashedCredentialsMatcher();
        hashedCredentialsMatcher.setHashAlgorithmName("MD5");
        hashedCredentialsMatcher.setHashIterations(1);

        AccountAuthorizationRealm  accountAuthorizationRealm = new AccountAuthorizationRealm();
        accountAuthorizationRealm.setCredentialsMatcher(hashedCredentialsMatcher);
